...
class CombinedFilteredSearchSpec extends Specification {
    ...
    def "should be able to parse title pr and userType eq Employee"() {
        ...
        then:
        cf.term1 instanceof UserSingularFilterChain
        cf.combinedWith == CombinedFilterChain.Combiner.AND
        cf.term2 instanceof UserSingularFilterChain
    }
    ...
    def "should be able to parse userType eq Employee and (emails co example.com or emails co example.org)"() {
        ...
        cf.term2.term1 instanceof UserSingularFilterChain
        ...
        cf.term2.term2 instanceof UserSingularFilterChain
